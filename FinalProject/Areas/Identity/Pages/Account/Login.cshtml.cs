    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            if (Adminrole == null)
            {
                ...
                user.UserName = "donia@gmail.com";
                user.Email = "donia@gmail.com";
                user.EmailConfirmed = true;
                user.FirstName = "Donia";
                user.LastName = "Wael";
                user.Address = "12Street";
                string userPWD = "Donia@123";

                await _userManager.CreateAsync(user, userPWD);
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (await _userManager.IsInRoleAsync(user, "Admin"))
                        ...
                        returnUrl ??= Url.Content("~/Customers/Customer/Index");
